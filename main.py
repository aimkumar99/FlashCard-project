...
def next_card():
   ...
   timer = window.after(3500, flip_card)
...
card_image = canvas.config(background=BACKGROUND_COLOR, highlightthickness=0)
...
known_button = Button(image=check_image, highlightthickness=0, command= when_known)
